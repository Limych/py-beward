        ...
        while True:
            try:
                ...
                (
                    ...
                    # "\x01\x08\x37\xe0"
                    # "\x01\x01\xa8\xc0" (gate_ip)  # noqa: E800
                    # "\x88\x13" (data_port)        # noqa: E800
                    # "\x00\x00\x01\x00\x00\x00"
                    # "\x5a\x01\xa8\xc0" (host_ip)  # noqa: E800
                    # "\x00\xff\xff\xff" "\x01\x01\xa8\xc0" (net_mask + gate_ip)    # noqa: E800
                    # "\x88\x13" "\x50\x00" (data_port + http_port)     # noqa: E800
                    # "\x01\x08\x37\xe0"
                    # "\x88\x13" (data_port)        # noqa: E800
                    # "\x00\x5a\x22\x30\x07\x5f" (mac)  # noqa: E800
                    # "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
                    # "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
                    # "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
                    # "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
                    ...
                    # "\x50\x00" "\x88\x13" (http_port + data_port)     # noqa: E800
                    # "\x00\x00"
                    ...
                    # "\x00\x00\x00\x00"
                    # "\x08\x08\x08\x08" (dns2_ip)      # noqa: E800
