...
class BewardCamera(BewardGeneric):
    ...
    def last_motion_timestamp(self):  # pragma: no cover
        """Get last motion timestamp."""
        warnings.warn(
            'The "last_motion_timestamp" property was renamed ' 'to "motion_timestamp"',
            DeprecationWarning,
        )
    ...
    def last_motion_image(self):  # pragma: no cover
        """Get last motion image."""
        warnings.warn(
            'The "last_motion_image" property was renamed ' 'to "motion_image"',
            DeprecationWarning,
        )
    ...
    def output1(self, state):
        ...
        self.query(
            "alarmout", extra_params={"channel": 0, "Output": 0, "Status": int(state)}
        )
    ...
    def output2(self, state):
        ...
        self.query(
            "alarmout", extra_params={"channel": 0, "Output": 1, "Status": int(state)}
        )
    ...
    def output3(self, state):
        ...
        self.query(
            "alarmout", extra_params={"channel": 0, "Output": 2, "Status": int(state)}
        )
